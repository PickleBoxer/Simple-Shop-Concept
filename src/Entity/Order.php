...
class Order
{
    ...
    //Therefore, when we will persist/remove an Order entity, 
    //Doctrine will automatically call persist/remove on each of the OrderItem objects associated with the Order entity.
